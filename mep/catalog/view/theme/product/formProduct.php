...
<script src="https://cdn.tiny.cloud/1/94h1g0ysrpfyl70trxyvbcz5ry1ltc6prqljg1mndfxmicjn/tinymce/5/tinymce.min.js" referrerpolicy="origin"/></script>
...
jQuery(document).ready(function($) {
	...
	$('#addthumbimg').click(function(event) {
		$.ajax({
			...
			type: 'POST',
			dataType: 'html',
			data: {name: 'product_thumb[]', id: 'product_thumb_'+imgrow},
